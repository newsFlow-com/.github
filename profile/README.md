...
| 레포지토리 | 역할 | 기술 스택 |
|------------|------|-----------|
| [newsFlow-FE](../../newsFlow-FE) | 프론트엔드 UI/UX | Next.js · TypeScript · Tailwind CSS |
| [newsFlow-BE-API](../../newsFlow-BE-API) | 메인 백엔드 API 서버 | Spring Boot · Java 17 · Redis · PostgreSQL |
| [newsFlow-BE-AI](../../newsFlow-BE-AI) | AI 추천 · 분석 엔진 | FastAPI · Python · Claude API · scikit-learn |
| [newsFlow-BE-DATA](../../newsFlow-BE-DATA) | 데이터 수집 파이프라인 | Scrapy · Airflow · PostgreSQL |
